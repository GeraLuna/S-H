<?php
	...
	if(!empty($_POST)){
		$valor = $_POST['campo'];
		if(!empty($valor)){
			$where = "WHERE tipo_usuario LIKE '%$valor%'";
			
		}
	}

	$tabla="SELECT id_tipo_user, tipo_usuario FROM tipo_usuario $where";
  	...
  	<script>
			$(document).ready(function(){
				$('#mitabla').DataTable({
					...
					"bProcessing": true,
					"bServerSide": true,
					"sAjaxSource": "controlador/tipousuario/buscar.php"
				});	
			});
		...
		<div class="contenedor-menu">
			...
			<ul class="menu">
				<li><a href=""><i class="icono izquierda fa fa-user" aria-hidden="true"></i>Usuarios<i class="icono derecha fa fa-angle-down" aria-hidden="true"></i></a>
					<ul>
						<li><a href="tipousuario.php" >Tipos de Usuario</a></li>
				...
				<li><a href=""><i class="icono izquierda fa fa-tags" aria-hidden="true"></i>Artículos<i class="icono derecha fa fa-angle-down" aria-hidden="true"></i></a>
					<ul>
						...
						<li><a href="../articulos/articulos" >Articulos</a></li>
					</ul>
				</li>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/tipousuario/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
								<label>Tipos de Usuario</label>
								<input type="text" name="tipo_usuario" id="tipo_usuario" class="form-control" required placeholder="Ingresa el Tipo de Usuario">
								<br>
			...
			<div class="modal fade" id="Buscador">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form  method="POST" id="brouse_form" accept-charset="utf-8">
								<label>Tipos de Usuario</label>
								<input type="text" name="campo" id="campo" class="form-control" placeholder="Ingresa un Dato">
								<br>
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="controlador/tipousuario/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
								<label>Tipo de Usuario</label>
								<input type="hidden" name="id_tipo_user" id="id_tipo_user" class="form-control" required placeholder="Ingresa el Id Tipo de Usuario">
								<br>
								<input type="text" name="tipousuario" id="tipousuario" class="form-control" required placeholder="Ingresa el Tipo de Usuario">
								<br>
		...
		<table class="display" id="tabla">
			...
			<tbody>
				<!--<?php
					...
					?>
					<tr>
						<!--<td><?php echo $row['id_tipo_user']; ?></td>-->
						<!--<td><?php echo $row['tipo_usuario']; ?></td>
						<!--<td><a href="" ><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a href="#" data-href="../../../controlador/tipousuario/eliminar.php?id_tipo_user=<?php echo $row['id_tipo_ user']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>-->
						<!--<td><a class="btn btn-info" data-toggle="modal" href="#Modificar">Modificar</a></td>-->
						<!--<td><a name="Modificar" id="<?php echo $row['id_tipo_user']; ?>" class="edit_data" title="Modificar Información"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a class="delete_data" href="#" data-href="controlador/tipousuario/eliminar.php?id_tipo_user=<?php echo $row['id_tipo_user']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
					/*../../../controlador/tipousuario/eliminar.php?id_tipo_user=<?php echo $row['id_tipo_user']; ?>*/
					}
				?>-->
			</tbody>
		</table>
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.edit_data', function(){
					var id_tipo_user = $(this).attr("id");
					$.ajax({
						url:"controlador/tipousuario/mostrar.php",
						method:"POST",
						data:{id_tipo_user:id_tipo_user},
						dataType:"json",
						success:function(data){
							$('#id_tipo_user').val(data.id_tipo_user);
