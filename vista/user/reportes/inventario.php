		...
		$(document).ready(function() {
			$("#id_categoria").change(function() {
				...
				$("#id_categoria option:selected").each(function() {
				    ...
				    $.post("../../../controlador/supuser/reportes/inventario/combos.php", { id_categoria: id_categoria }, function(data) {
...
<body>
	...
	<nav class="bar-horizon">
		...
		<div class="contenido">
			...
			<div class="botones">
				<div id="izquierda">
					<form action="../../../controlador/supuser/reportes/inventario/inventario_general.php" method="post" id="insert_form" accept-charset="utf-8">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/reportes/inventario/inventario_categoria.php" method="post" id="insert_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Reporte_Articulo">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/reportes/inventario/inventario_articulo.php" method="post" id="insert_form" accept-charset="utf-8">
								<label>Categoria de Articulos</label>
