				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<!--<form action="../../../controlador/user/salida/buscar.php" method="post" id="brouse_form" accept-charset="utf-8">
							...
							<form action="../../../controlador/user/salida/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/user/salida/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td><a class="delete_data" href="#" data-href="../../../controlador/user/salida/eliminar.php?id_salida=<?php echo $row['id_salida']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>-->
					</tr>
					<?php
					}
				?>
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.view_data', function(){  
           			...
           			if(id_salida != '')  {  
                		$.ajax({  
                     	url:"../../../controlador/user/salida/ver.php",  
                     	method:"POST",  
				...
				$(document).on('click', '.edit_data', function(){
					var id_salida = $(this).attr("id");
					$.ajax({
						url:"../../../controlador/user/salida/mostrar.php",
						method:"POST",
						data:{id_salida:id_salida},
						dataType:"json",
						success:function(data){
