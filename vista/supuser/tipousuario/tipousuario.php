				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/tipousuario/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/tipousuario/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td><a class="delete_data" href="#" data-href="../../../controlador/supuser/tipousuario/eliminar.php?id_tipo_user=<?php echo $row['id_tipo_user']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.edit_data', function(){
					...
					$.ajax({
						url:"../../../controlador/supuser/tipousuario/mostrar.php",
						method:"POST",
