				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/articulos/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/articulos/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td><a class="delete_data" href="#" data-href="../../../controlador/supuser/articulos/eliminar.php?id_articulo=<?php echo $row['id_articulo']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
					}
				?>
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.edit_data', function(){
					...
					$.ajax({
						url:"../../../controlador/supuser/articulos/mostrar.php",
						method:"POST",
