	...
	<nav class="bar-horizon">
		...
		<div class="contenido">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h2 class="modal-tittle">Registrar Tipos de Usuario</h2>
						</div>
						<div class="modal-body">
							<form action="../../../controlador/supuser/usuarios/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
								<label>Nombre</label>
								<input type="text" name="nom_user" id="nom_user" class="form-control" required placeholder="Ingresa el Nombre">
								<label>Usuario</label>
								<input type="text" name="user" id="user" class="form-control" required placeholder="Ingresa el Usuario">
								<label>Contraseña</label>
								<input type="password" name="pass" id="pass" class="form-control" required placeholder="Ingresa la Contraseña">
								<label>Tipo de Usuario</label>
 								<select name="id_tipo_user" id="id_tipo_user" class="form-control">
										<option value="0" required>Seleccionar</option>
										<?php 
								  			$consult="select id_tipo_user, tipo_usuario from tipo_usuario";
											$result = $conexion->query($consult);
								  			while ($row = $result->fetch_assoc()) {
								  					//echo "<option value=".'["id_tipouser"]'.">".'["tipo_user"]'."</option>";
										?>
										<option value="<?php echo $row['id_tipo_user']; ?>"><?php echo utf8_decode($row['tipo_usuario']); ?></option>
			...
			<div class="modal fade" id="Buscador">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h2 class="modal-tittle">Buscar Usuario</h2>
						</div>
						<div class="modal-body">
							<form action="../../../controlador/supuser/usuarios/buscar.php" method="post" id="brouse_form" accept-charset="utf-8">
								<label>Usuario</label>
								<input type="text" name="buscar_usuario" id="buscar_usuario" class="form-control" required placeholder="Ingresa un Dato">
								<br>
			...
			<div class="modal fade" id="Contrasena">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h2 class="modal-tittle">Cambiar Contraseña</h2>
						</div>
						<div class="modal-body">
							<form action="../../../controlador/supuser/usuarios/contrasena.php" method="post" id="pass_form" accept-charset="utf-8">
								<input type="hidden" name="iduser" id="iduser" class="form-control" required placeholder="Ingresa el Nombre">
								<label>Nombre</label>
								<input type="text" REQUIRED disabled name="nombre" id="nombre" class="form-control" required placeholder="Ingresa la Contraseña">
								<label>Contraseña</label>
								<input type="password" name="password" id="password" class="form-control" required placeholder="Ingresa la Contraseña">
								<br>
								<input type="submit" name="pass" id="pass" value="Modificar" class="btn btn-success">
							</form>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h2 class="modal-tittle">Modificar Usuario</h2>
						</div>
						<div class="modal-body">
							<form action="../../../controlador/supuser/usuarios/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
								<input type="hidden" name="id_user" id="id_user" class="form-control" required placeholder="Ingresa el Nombre">
								<label>Nombre</label>
								<input type="text" name="nomuser" id="nomuser" class="form-control" required placeholder="Ingresa el Nombre">
								<label>Usuario</label>
								<input type="text" name="usuario" id="usuario" class="form-control" required placeholder="Ingresa el Usuario">
								<label>Tipo de Usuario</label>
 								<select name="id_tipouser" id="id_tipouser" class="form-control">
										<option value="0" required>Seleccionar</option>
										<?php 
								  			$consult="select id_tipo_user, tipo_usuario from tipo_usuario";
											$result = $conexion->query($consult);
			...
			<div class="row table-responsive">
				...
				<tbody>
				<?php
					$tabla="SELECT id_user, nom_user, user, pass, tipo_usuario FROM usuarios, tipo_usuario WHERE usuarios.id_tipo_user = tipo_usuario.id_tipo_user";
					...
					<tr>
						...
						<td><a name="Contraseña" id="<?php echo $row['id_user']; ?>" class="pass_data" title="Modificar Contraseña"><span class="glyphicon glyphicon-asterisk"></span></a></td>
						<td><a name="Modificar" id="<?php echo $row['id_user']; ?>" class="edit_data" title="Modificar Información"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a class="delete_data" href="#" data-href="../../../controlador/supuser/usuarios/eliminar.php?id_user=<?php echo $row['id_user']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
					}
				?>
			...
			$(document).ready(function(){
				...
				$(document).on('click', '.pass_data', function(){
					...
					$.ajax({
						url:"../../../controlador/supuser/usuarios/mostrar.php",
						method:"POST",
						data:{id_user:id_user},
						dataType:"json",
						success:function(data){
							$('#iduser').val(data.id_user);
							$('#nombre').val(data.nom_user);
				...
				$(document).on('click', '.edit_data', function(){
					...
					$.ajax({
						...
						success:function(data){
							...
							$('#nomuser').val(data.nom_user);
							$('#usuario').val(data.user);
							/*$('#password').val(data.pass);*/
							$('#id_tipouser').val(data.id_tipo_user);
