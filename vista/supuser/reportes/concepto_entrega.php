...
<body>
	...
	<nav class="bar-horizon">
		...
		<div class="contenido">
			...
			<div class="botones">
				<div id="izquierda">
					<form action="../../../controlador/supuser/reportes/concepto_entregas/concepto_entregas_general.php" method="post" id="insert_form" accept-charset="utf-8">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/reportes/concepto_entregas/concepto_entregas_mensual.php" method="post" id="insert_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Reporte_Diario">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/reportes/concepto_entregas/concepto_entregas_diario.php" method="post" id="insert_form" accept-charset="utf-8">
								<label>Concepto de Entrega</label>
 								<select name="id_concepto" id="id_concepto" class="form-control">
										<option value="0" required>Seleccionar</option>
										<?php 
