...
<body>
	...
	<nav class="bar-horizon">
		...
		<div class="contenido">
			<header>
				<h1>Reporte de Entrada de Artículos</h1>
			</header>
			<section class="main">
			<div class="botones">
				<div id="izquierda">
					<form action="../../../controlador/supuser/reportes/entregas_usuario/entregas_usuario_general.php" method="post" id="insert_form" accept-charset="utf-8">
