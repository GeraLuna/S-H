<?php
	...
	if(!empty($_POST)){
		$valor = $_POST['campo'];
		if(!empty($valor)){
			$where = "WHERE tipo_concepto LIKE '%$valor%'";
			
		}
	}

	$tabla="SELECT id_tipo_concepto, tipo_concepto FROM tipo_concepto  $where";
		...
		<div class="contenedor-menu">
			...
			<ul class="menu">
				...
				<li><a href=""><i class="icono izquierda fa fa-archive" aria-hidden="true"></i>Almacén<i class="icono derecha fa fa-angle-down" aria-hidden="true"></i></a>
					<ul>
						<li><a href="tipoconcepto.php" >Tipo de Concepto</a></li>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h2 class="modal-tittle">Registrar el Tipo de Concepto</h2>
						</div>
						<div class="modal-body">
							<form action="../../../controlador/supuser/tipoconcepto/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
								<label>Nombre del Tipo de Concepto</label>
								<input type="text" name="tipo_concepto" id="tipo_concepto" class="form-control" required placeholder="Ingresa el Nombre del Tipo de Concepto">
								<br>
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h2 class="modal-tittle">Modificar El tipo de Concepto</h2>
						</div>
						<div class="modal-body">
							<form action="../../../controlador/supuser/tipoconcepto/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
								<label>Nombre del Tipo de Concepto</label>
								<input type="hidden" name="id_tipo_concepto" id="id_tipo_concepto" class="form-control" required placeholder="Ingresa el Id Puesto">
								<br>
								<input type="text" name="type_concept" id="type_concept" class="form-control" required placeholder="Ingresa el Departamento">
								<br>
		...
		<table class="display" id="mitabla">
			...
			<tbody>
				<?php
					...
					?>
					<tr>
						<!--<td><?php echo $row['id_tipo_concepto']; ?></td>-->
						<td><?php echo $row['tipo_concepto']; ?></td>
						<td><a name="Modificar"  id="<?php echo $row['id_tipo_concepto']; ?>" class="edit_data" title="Modificar Información"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a class="delete_data" href="#" data-href="../../../controlador/supuser/tipoconcepto/eliminar.php?id_tipo_concepto=<?php echo $row['id_tipo_concepto']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
					}
				?>
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.edit_data', function(){
					var id_tipo_concepto = $(this).attr("id");
					$.ajax({
						url:"../../../controlador/supuser/tipoconcepto/mostrar.php",
						method:"POST",
						data:{id_tipo_concepto:id_tipo_concepto},
						dataType:"json",
						success:function(data){
							$('#id_tipo_concepto').val(data.id_tipo_concepto);
							$('#type_concept').val(data.tipo_concepto);
	...
	<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					¿Desea Eliminar el Tipo de Concepto?
					<br><br>
