<?php
	...
	$tabla="SELECT id_concepto, tipo_concepto, concepto FROM concepto, tipo_concepto WHERE $where concepto.id_tipo_concepto = tipo_concepto.id_tipo_concepto";
...
<head>
	...
	<title>Concepto de Artículos</title>
			...
			<ul class="menu">
				...
				<li><a href=""><i class="icono izquierda fa fa-archive" aria-hidden="true"></i>Almacén<i class="icono derecha fa fa-angle-down" aria-hidden="true"></i></a>
					<ul>
						...
						<li><a href="concepto.php" >Concepto de Articulos</a></li>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h2 class="modal-tittle">Registrar Concepto</h2>
						</div>
						<div class="modal-body">
							<form action="../../../controlador/supuser/concepto/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
								<label>Tipo de Concepto</label>
 								<select name="id_tipo_concepto" id="id_tipo_concepto" class="form-control">
										<option value="0" required>Seleccionar</option>
										<?php 
								  			$consult="select id_tipo_concepto, tipo_concepto from tipo_concepto";
											$result = $conexion->query($consult);
								  			while ($row = $result->fetch_assoc()) {
								  					//echo "<option value=".'["id_tipouser"]'.">".'["tipo_user"]'."</option>";
										?>
										<option value="<?php echo $row['id_tipo_concepto']; ?>"><?php echo utf8_decode($row['tipo_concepto']); ?></option>
								   			
										<?php } ?>
								</select><br>
								<label>Concepto</label>
								<input type="text" name="concepto" id="concepto" class="form-control" required placeholder="Ingresa el Nombre del Concepto">
								<br>
			...
			<!--<div class="modal fade" id="Buscador">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/departamentos/buscar.php" method="post" id="brouse_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/supuser/concepto/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
								
								<input type="hidden" name="id_concepto" id="id_concepto" class="form-control" required placeholder="Ingresa el Id Concepto">
								<label>Tipo de Concepto</label>
 								<select name="id_type_concept" id="id_type_concept" class="form-control">
										<option value="0" required>Seleccionar</option>
										<?php 
								  			$consult="select id_tipo_concepto, tipo_concepto from tipo_concepto";
											$result = $conexion->query($consult);
								...
								<label>Concepto</label>
								<input type="text" name="concept" id="concept" class="form-control" required placeholder="Ingresa el Nombre del Concepto del Articulo">
								<br>
			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td><?php echo $row['tipo_concepto']; ?></td>
						<td><?php echo $row['concepto']; ?></td>
						<td><a name="Modificar" id="<?php echo $row['id_concepto']; ?>" class="edit_data" title="Modificar Información"><span class="glyphicon glyphicon-pencil"></span></a></td>
						<td><a class="delete_data" href="#" data-href="../../../controlador/supuser/concepto/eliminar.php?id_concepto=<?php echo $row['id_concepto']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
					}
				?>
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.edit_data', function(){
					var id_concepto = $(this).attr("id");
					$.ajax({
						url:"../../../controlador/supuser/concepto/mostrar.php",
						method:"POST",
						data:{id_concepto:id_concepto},
						dataType:"json",
						success:function(data){
							$('#id_concepto').val(data.id_concepto);
							$('#id_type_concept').val(data.id_tipo_concepto);
	...
	<div class="modal fade" id="confirm-delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					¿Desea Eliminar el Concepto del Artículo?<br><br>
