				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/admin/puestos/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
								<label>Puesto</label>
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/admin/puestos/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
								<label>Puesto</label>
			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td><a class="delete_data" href="#" data-href="../../../controlador/admin/puestos/eliminar.php?id_puesto=<?php echo $row['id_puesto']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
					}
				?>
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.edit_data', function(){
					...
					$.ajax({
						url:"../../../controlador/admin/puestos/mostrar.php",
						method:"POST",
