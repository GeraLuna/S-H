		...
		$(document).ready(function() {
			$("#id_depto").change(function() {
				...
				$("#id_depto option:selected").each(function() {
				    id_depto = $(this).val();
				    $.post("../../../controlador/admin/personal/combos.php", { id_depto: id_depto }, function(data) {
				    	$("#id_puesto").html(data);
				    });
				});
			});
		...
		$(document).ready(function() {
			$("#iddepto").change(function() {
				...
				$("#iddepto option:selected").each(function() {
				    iddepto = $(this).val();
				    $.post("../../../controlador/admin/personal/combos_edit.php", { iddepto: iddepto }, function(data) {
				    	$("#idpuesto").html(data);
				    });
				});
			});
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/admin/personal/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/admin/personal/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td><a class="delete_data" href="#" data-href="../../../controlador/admin/personal/eliminar.php?id_personal=<?php echo $row['id_personal']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
					}
				?>
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.view_data', function(){  
           			...
           			if(id_personal != '')  {  
                		$.ajax({  
                     	url:"../../../controlador/admin/personal/ver.php",  
                     	method:"POST",  
				...
				$(document).on('click', '.edit_data', function(){
					var id_personal = $(this).attr("id");
					$.ajax({
						url:"../../../controlador/admin/personal/mostrar.php",
						method:"POST",
						data:{id_personal:id_personal},
						dataType:"json",
						success:function(data){
