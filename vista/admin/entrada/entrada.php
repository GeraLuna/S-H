				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/admin/entrada/registrar.php" method="post" id="insert_form" accept-charset="utf-8">
			...
			<div class="modal fade" id="Modificar">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="../../../controlador/admin/entrada/modificar.php" method="post" id="modify_form" accept-charset="utf-8">
			...
			<tbody>
				<?php
					...
					<tr>
						...
						<td><a class="delete_data" href="#" data-href="../../../controlador/admin/entrada/eliminar.php?id_entrada=<?php echo $row['id_entrada']; ?>" data-toggle="modal" data-target="#confirm-delete" title="Eliminar Registro"><span class="glyphicon glyphicon-trash"></span></a></td>
					</tr>
					<?php
					}
				?>
		...
		<script>
			$(document).ready(function(){
				...
				$(document).on('click', '.view_data', function(){  
           			...
           			if(id_entrada != '')  {  
                		$.ajax({  
                     	url:"../../../controlador/admin/entrada/ver.php",  
                     	method:"POST",  
				...
				$(document).on('click', '.edit_data', function(){
					var id_entrada = $(this).attr("id");
					$.ajax({
						url:"../../../controlador/admin/entrada/mostrar.php",
						method:"POST",
						data:{id_entrada:id_entrada},
						dataType:"json",
						success:function(data){
